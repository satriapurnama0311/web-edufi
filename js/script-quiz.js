...
const question = [
  {
    question: "Dibawah ini manakah yang bukan teknik pencahayaan?",
    optionA: "Intensitas Cahaya",
    optionB: "Arah Cahaya",
    optionC: "Sumber Cahaya",
    optionD: "Gerbang Cahaya",
    correctOption: "optionD",
  },

  {
    question:
      "Sudut pandang dalam pemotretan dengan kedudukan lebih rendah dari object yang akan menghasilkan gambar seolah-olah lebih tinggi dari aslinya dan terkesan dominan disebut?",
    optionA: "High Angle",
    optionB: "Low Angle",
    optionC: "Eye Level",
    optionD: "Frog Eye Level",
    correctOption: "optionB",
  },

  {
    question:
      "Teknik memfoto object dari bawah serta posisinya lebih rendah dari objek disebut?",
    optionA: "High Angle",
    optionB: "Low Angle",
    optionC: "Eye Level",
    optionD: "Frog Eye Level",
  ...
  {
    question: "Rentang waktu kamera menangkap cahaya yang masuk disebut?",
    optionA: "Iso",
    optionB: "Sutter Speed",
    optionC: "Apeture",
    optionD: "Stabilizer",
    correctOption: "optionB",
  },
  ...
  {
    question:
      "Komponen dari lensa yang berfungsi mengatur intensitas cahaya yang masuk ke kamera disebut?",
    optionA: "Iso",
    optionB: "Sutter Speed",
    optionC: "Apeture",
    optionD: "Stabilizer",
